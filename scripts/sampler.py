...
class StepSDE:
    ...
    def __call__(self, x, mean_x, t, model, **model_kwargs):
        return self.sampler(x=x, mean_x=mean_x, t=t, model=model, **model_kwargs)
...
# NOTE: The "model" is in this case the forward_with_cfg function that gets called
    ...
    def sample(
        ...
        model_forward_fn = partial(forward_with_cfg, model=model, cond=cond, cfg_scale=cfg_scale, uc_cond=uc_cond)
